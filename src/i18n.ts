...
const STRINGS: Record<Lang, Strings> = {
  en: {
    ...
    enums: {
      ...
      problems: {
        problem: 'Problem',
        water_tray_low: 'Water tray low',
        pump_problem: 'Pump problem',
        food_low: 'Food low',
        bowl_removed: 'Bowl removed',
        tilted: 'Tilted',
  ...
  de: {
    ...
    enums: {
      ...
      problems: {
        problem: 'Problem',
        water_tray_low: 'Wassertablett niedrig',
        pump_problem: 'Pumpenproblem',
        food_low: 'Futter niedrig',
